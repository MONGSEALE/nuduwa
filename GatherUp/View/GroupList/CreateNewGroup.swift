...
//                    let post = Post(text: postText, imageURL: downloadURL, imageReferenceID: imageReferenceID, userName: userName, userUID: userUID, userImage: profileURL)
//                    try await createDocumentAtFirebase(post)
//                }else{
//                    /// Step 2: Directly Post Text Data to Firebase (Since there is no Images Present)
//                    let post = Post(text: postText, userName: userName, userUID: userUID, userImage: profileURL)
//                    try await createDocumentAtFirebase(post)
//                }
//            }
//        }
...
//    }
//    
//    // MARK: Displaying Erros as Alert
